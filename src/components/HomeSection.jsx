  ...
  return (
    <div className="flex w-full h-screen bg-gray-50 relative">
      ...
      <div className="flex-1 overflow-auto md:pl-20 pt-20 relative">
        ...
        {active === "layanan" && (
          <p className="text-gray-700">Ini halaman Layanan</p>
        )}
        {active === "history" && (
          <p className="text-gray-700">Ini halaman History & Status</p>
        )}
        {active === "notifikasi" && (
          <p className="text-gray-700">Ini halaman Notifikasi</p>
        )}
        {active === "settings" && (
          <p className="text-gray-700">Ini halaman Settings</p>
        )}
      </div>
    </div>
  );
