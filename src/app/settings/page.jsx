      ...
      <div className="p-6 max-w-md mx-auto">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            />
            <span className="text-gray-700 text-sm">Profile picture (read-only)</span>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <input
              ...
              className="border border-blue-200 rounded-lg px-4 py-2 bg-gray-50 text-gray-700 focus:outline-none"
            />
            <span className="text-gray-500 text-sm mt-1">Password tidak bisa diubah sementara</span>
          </div>
        </div>
      </div>
    </DashboardLayout>
