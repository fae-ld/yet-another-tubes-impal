...
const StepCard = ({ number, title, description, imageSrc }) => (
  <div className="text-center p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100">
    ...
    <p className="text-sm font-semibold text-[#00A6FB] mb-1">
      LANGKAH {number}
    </p>
...
export default function HomePageContent() {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header / Hero Section */}
      <header
        className="relative text-white pt-24 pb-32 md:pt-32 md:pb-48 overflow-hidden"
        style={{
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-start justify-center h-full">
          ...
          <h1 className="font-rethink text-[40px] leading-[40px] font-extrabold mb-4 max-w-2xl text-left">
            Bersihkan Pakaianmu dan Dapatkan Layanan Terbaik Tanpa Harus Keluar
            Rumah
          </h1>
        ...
        <div className="flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="md:w-2/3">
            <p className="text-gray-600 mb-4 text-lg leading-relaxed">
              <span className="font-bold">LaundryGo</span> adalah layanan
              *laundry* digital yang dirancang untuk memudahkan hidup Anda.
              Lewat aplikasi, Anda dapat mencuci pakaian secara mandiri dengan
              cepat, praktis, dan transparan tanpa harus antre atau bergantung
              pada staf.
            </p>
            <p className="text-gray-600 text-lg leading-relaxed">
              Kami menghadirkan pengalaman *self-service* yang efisien dan
              modern, sehingga Anda bisa mengatur waktu dengan lebih fleksibel.
              Semua proses dirancang agar mudah digunakan, bahkan bagi pengguna
              baru.
            </p>
          </div>
        </div>
